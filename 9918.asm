...
T_R1_INC_ONE		EQU	04 ; Increment address by one (TEXT8_80 mode)
...
T_T80_VRAM_ATTR_ADDRESS		EQU	3000h  ; Color attributes address. Added for 8 pix wide 80x30 text color mode (each symbol with it's own color)
